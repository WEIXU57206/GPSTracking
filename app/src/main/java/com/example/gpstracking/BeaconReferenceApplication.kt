...
open class BeaconReferenceApplication: Application() {
    ...
    override fun onCreate() {
        ...
        val eddystoneUIDParser = BeaconParser().
        setBeaconLayout("s:0-1=fed8,m:2-2=00,p:3-3:-41,i:4-13,i:14-19")
    ...
    fun setupForegroundService() {
        ...
        val intent = Intent(this, PermissionsMain::class.java)
    ...
    val centralRangingObserver = Observer<Collection<Beacon>> { beacons ->
        ...
        if (rangeAgeMillis < 10000) {
            Log.d(PermissionsMain.TAG, "Ranged: ${beacons.count()} beacons")
            for (beacon: Beacon in beacons) {
                Log.d(TAG, "$beacon about ${beacon.distance} meters away")
            }
        }
        else {
            Log.d(PermissionsMain.TAG, "Ignoring stale ranged beacons from $rangeAgeMillis millis ago")
        }
    }
    ...
    private fun sendNotification() {
        ...
        stackBuilder.addNextIntent(Intent(this, PermissionsMain::class.java))
